          ...
          <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
            <div className="flex items-center justify-center gap-4">
              ...
              <img 
                src={auralisLogo} 
                alt="Auralis Logo" 
                className="w-16 h-16 md:w-20 md:h-20 animate-scale-in opacity-90 drop-shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:opacity-100 transition-opacity duration-300"
              />
            </div>
